...
class PredictionModel(DenoisePretrainModel):
    def __init__(self, model_type, hidden_size, n_channel,
                 ...
                 hierarchical=False, no_block_embedding=False, n_egnn_layers=3) -> None:
        super().__init__(
            ...
            hierarchical=hierarchical, no_block_embedding=no_block_embedding, n_egnn_layers=n_egnn_layers)
    ...
    def load_from_pretrained(cls, pretrain_ckpt, **kwargs):
        ...
        model = cls(
            ...
            n_egnn_layers=getattr(pretrained_model, 'n_egnn_layers', 3),
            **kwargs
        )
