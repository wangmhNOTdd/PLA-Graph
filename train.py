...
def parse():
    ...
    # model
    parser.add_argument('--model_type', type=str, required=True, choices=['GET', 'GETPool', 'SchNet', 'EGNN', 'DimeNet', 'TorchMD', 'Equiformer', 'GemNet', 'MACE', 'MACE-En', 'LEFTNet', 'HEGN', 'EIGN', 'DSAN'], help='type of model to use')
