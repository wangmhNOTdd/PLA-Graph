...
def parse():
    ...
    # model
    parser.add_argument('--model_type', type=str, required=True, choices=['GET', 'GETPool', 'SchNet', 'EGNN', 'DimeNet', 'TorchMD', 'Equiformer', 'GemNet', 'MACE', 'MACE-En', 'LEFTNet', 'HEGN', 'EIGN', 'DSAN', 'GCNESA'], help='type of model to use')
    ...
    parser.add_argument('--n_egnn_layers', type=int, default=3, help='Number of EGNN layers for HEGN model')
